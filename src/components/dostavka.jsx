    ...
    <div className="container" style={{ display: "flex", flexDirection: "column", minHeight: "100vh" }}>
      ...
      <header className="header">
        <div className="left-section">
          <div className="mobile-toggle"><i className="bx bx-menu bx-tada-hover"></i></div>
          <div className="logo"><Link to="/"><img src={qaraaLogo} alt="Logo" className="logo" /></Link></div>
          <nav>
        ...
        <div className="logo_2"><Link to="/"><img src={qaraaLogo} alt="Logo" className="logo_2" /></Link></div>
      </header>

      {/* MAIN */}
      <main style={{ flex: "1 0 auto", backgroundColor: "#fafafa", padding: "0", margin: "0" }}>
        {/* Hero */}
        <section style={{ backgroundColor: "#ffffff", padding: "4rem 2rem", textAlign: "center", borderBottom: "1px solid #f0f0f0" }}>
          <h1 style={{ fontSize: "2.5rem", fontWeight: "300", color: "#333", margin: "0 0 1rem 0" }}>Доставка</h1>
        ...
        <section style={{ maxWidth: "1000px", margin: "0 auto", padding: "4rem 2rem" }}>
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(300px, 1fr))", gap: "2rem", marginBottom: "3rem" }}>
            ...
            <Card iconClass="bx-credit-card" title="Оплата">
              <ul style={{ listStyle: "none", padding: "0", margin: "0", color: "#666", lineHeight: "1.8" }}>
                <li><img src={require("../images/kaspi.png")} alt="Kaspi" style={{ width: "20px", marginRight: "8px" }} />Kaspi</li>
                <li><img src={require("../images/halyk.png")} alt="Halyk" style={{ width: "20px", marginRight: "8px" }} />Halyk</li>
                <li><img src={require("../images/freedom.png")} alt="Freedom" style={{ width: "20px", marginRight: "8px" }} />Freedom</li>
                <li><img src={require("../images/cash.png")} alt="Cash" style={{ width: "20px", marginRight: "8px" }} />Наличными при получении</li>
              </ul>
            </Card>
          ...
          <div style={{ backgroundColor: "#ffffff", padding: "2rem", borderRadius: "8px", boxShadow: "0 2px 10px rgba(0,0,0,0.05)", border: "1px solid #f0f0f0" }}>
            ...
            <div style={{ display: "grid", gap: "1.5rem" }}>
              ...
              {/* <div>
                <h4 style={{ fontSize: "1.1rem", fontWeight: "500", color: "#333", marginBottom: "0.5rem" }}>Есть ли бесплатная доставка?</h4>
                <p style={{ color: "#666", lineHeight: "1.6", margin: "0" }}>Бесплатная доставка предоставляется при заказе от 15,000 тенге по Астане.</p>
              </div> */}
            </div>
          </div>
        </section>
      ...
      <footer className="footer" style={{ flexShrink: 0 }}>
        <div className="footer-content">
          ...
          <ul className="socials">
            <li><a href="https://www.instagram.com/qaraa.kz/" target="_blank" rel="noreferrer"><i className="bx bxl-instagram-alt bx-tada"></i></a></li>
            <li><a href="https://wa.me/7778307588" target="_blank" rel="noreferrer"><i className="bx bxl-whatsapp bx-tada"></i></a></li>
            <li><a href="https://www.tiktok.com/@qaraa.kz" target="_blank" rel="noreferrer"><i className="bx bxl-tiktok bx-tada"></i></a></li>
            <li><a href="https://t.me/qaraa_kz" target="_blank" rel="noreferrer"><i className="bx bxl-telegram bx-tada"></i></a></li>
          </ul>
        </div>
